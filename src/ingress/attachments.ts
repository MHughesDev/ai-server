...
const DEFAULT_LIMITS: AttachmentValidationLimits = {
  maxCount: 10,
...
export function getDefaultAttachmentLimits(): AttachmentValidationLimits {
...
export function validateAttachments(
  ...
  limits: Partial<AttachmentValidationLimits> = {}
