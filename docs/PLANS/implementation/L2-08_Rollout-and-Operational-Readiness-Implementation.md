...
- **Handoff:** `docs/PLANS/implementation/L2-08_Handoff.md` for L2-99 and Operations (checklist, config, rollout policy, endpoints, runbooks, remaining operational phases).
