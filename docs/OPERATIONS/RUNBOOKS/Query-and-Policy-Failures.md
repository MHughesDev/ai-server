...
- Normative production behavior: `docs/ARCHITECTURE/Architecture_document_Finalized.md` (Section 18).
...
- `docs/OPERATIONS/RUNBOOKS/Multimodal-Input-Path.md` for attachment-related failures.
