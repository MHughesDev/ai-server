...
**Last task closed:** PR-014 — executable tools security review sign-off (2026-05-20)
...
| ID | Task | Status | Priority | Evidence / files |
|----|------|--------|----------|------------------|
| PR-020 | Fix timer leaks on success paths in model/tool gateway races | open | P1 | `model-gateway.ts`, `tool-gateway.ts` |
...
| ID | Task | Status | Priority | Evidence / files |
|----|------|--------|----------|------------------|
| PR-030 | CI/CD: signed artifacts, manifest validation, pre-release smoke | open | P0 | `.github/` / GitLab CI |
...
|----|--------------|--------|----------|----------------|
| WANT-004 | Orchestrator sole authority for loops/budgets/mode | partial | P0 | Centralize pipeline-local iteration; full budget+mode in orchestrator |
...
| P4-01 | Rollback drill + incident drill | open | P0 |
