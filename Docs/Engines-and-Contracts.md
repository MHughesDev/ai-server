...
**Source of truth for shapes:** `docs/Architecture_document_Finalized.md` (§8.4–8.6, §10).  
**Source of truth for production requirements:** `docs/Architecture_document_Finalized.md` (§18).  
...
- **Architecture:** `docs/Architecture_document_Finalized.md` (§8.4–8.7, §9.4–9.5, §10).
