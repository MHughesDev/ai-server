...
**Production-target reference:** `docs/Architecture_document_Finalized.md` (Sections 8 and 18).  
**Current-state delta reference:** `docs/Production-Readiness-Gaps-Report.md`.
...
- **Architecture:** `docs/Architecture_document_Finalized.md` §8.4 (Typed Artifact), §8.6 (Engine I/O).
