...
- Normative production requirements: `docs/ARCHITECTURE/Architecture_document_Finalized.md` (Section 18).
...
- **Query and policy triage:** For query failure, tool denied, or budget exceeded (non-rollback), see `docs/OPERATIONS/RUNBOOKS/Query-and-Policy-Failures.md`.
...
- `docs/OPERATIONS/RUNBOOKS/Observability-and-Eval.md`
