...
**Handoff artifact:** [L2-01_Handoff.md](./L2-01_Handoff.md) (checklist, compatibility matrix, schema examples, CI commands, known limits, open risks). Runbook: [CI-Bootstrap-Troubleshooting.md](../../OPERATIONS/RUNBOOKS/CI-Bootstrap-Troubleshooting.md).
